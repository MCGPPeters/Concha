...
Function New-Solution 
{
	...
	Process	
	{
		...
		Invoke-WebRequest 'https://nuget.org/nuget.exe' -OutFile (Join-Path -Path $solutionFolderStructure.NuGetFolderDirectoryInfo.FullName -ChildPath 'nuget.exe') -Verbose
