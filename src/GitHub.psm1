		...
		try 
        {
            ...
            Foreach-Object -Process { $_ | 
                    Foreach-Object -Process {
                        ...
                        $issue.Assignee = [GitHubUser]::New()
                        $issue.Assignee.Id = $_.assignee.id
		                    $issue.Assignee.Login = $_.assignee.login
		                    $issue.Assignee.AvatarUrl = ConvertTo-Url -String $_.assignee.avatarUrl            
		                    $issue.Assignee.GravatarId = ConvertTo-Url -String $_.assignee.gravatar_id
		                    $issue.Assignee.Url = ConvertTo-Url -String $_.assignee.url
		                    $issue.Assignee.HTMLUrl = ConvertTo-Url -String $_.assignee.htmlUrl
		                    $issue.Assignee.FollowersUrl = ConvertTo-Url -String $_.assignee.followersUrl
		                    $issue.Assignee.FollowingUrl = ConvertTo-Url -String $_.assignee.followingUrl
		                    $issue.Assignee.GistsUrl = ConvertTo-Url -String $_.assignee.gistsUrl
		                    $issue.Assignee.StarredUrl = ConvertTo-Url -String $_.assignee.starredUrl
		                    $issue.Assignee.SubscriptionsUrl = ConvertTo-Url -String $_.assignee.subscriptionsUrl
		                    $issue.Assignee.OrganizationsUrl = ConvertTo-Url -String $_.assignee.organizationsUrl
		                    $issue.Assignee.ReposUrl = ConvertTo-Url -String $_.assignee.reposUrl
		                    $issue.Assignee.EventsUrl = ConvertTo-Url -String $_.assignee.eventsUrl
		                    $issue.Assignee.ReceivedEventsUrl = ConvertTo-Url -String $_.assignee.received_eventsUrl
		                    $issue.Assignee.Type = $_.assignee.type
		                    $issue.Assignee.IsSiteAdmin = $_.assignee.site_admin
